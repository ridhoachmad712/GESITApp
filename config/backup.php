...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Aset tak tergantikan: file arsip dokumen.
                    // (Kode ada di Git, jadi tidak ikut di-backup.)
         ...
         */
        // Gzip butuh binary `gzip` (ada di server Linux, tidak ada di Windows).
        // Set BACKUP_COMPRESS_DB=true di production.
        'database_dump_compressor' => env('BACKUP_COMPRESS_DB', false)
        ...
        'destination' => [
             ...
             */
            // Tujuan backup. Default 'local' (storage/app/private/SIARSIP Manajemen).
            // Untuk tujuan eksternal (WAJIB di production — backup di server yang
            // sama = bukan backup), tambahkan disk S3/FTP/Google Drive di
            // config/filesystems.php lalu set BACKUP_DISK di .env.
            'disks' => [
    ...
    'notifications' => [
        'notifications' => [
            // Hanya kegagalan yang dikirim email — backup sukses tidak perlu spam.
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@manajemen-feb.unm.ac.id'),
